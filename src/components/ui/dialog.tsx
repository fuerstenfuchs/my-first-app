...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      {/* Clip trick: outer overflow-hidden clips scrollbar, inner extends 17px right */}
      <div className="relative flex-1 min-h-0 overflow-hidden">
        <div
          className="absolute inset-y-0 left-0 overflow-y-auto overflow-x-hidden grid gap-4 p-6 content-start"
          style={{ right: '-17px' }}
        >
          {children}
        </div>
