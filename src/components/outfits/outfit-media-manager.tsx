...
export function OutfitMediaManager({
  ...
  return (
    <div className="space-y-3">
      <div
        className={cn('rounded-lg border-2 border-dashed transition-colors p-4', isDragOver ? 'border-orange-500 bg-orange-500/10' : 'border-white/10 hover:border-white/20')}
